# React — Specifications Index

This folder is the **specification layer**  It decomposes the plan into unified feature specs, a shared boundary (contracts), and side-of-the-stack implementation specs.
