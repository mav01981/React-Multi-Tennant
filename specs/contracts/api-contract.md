...
> This file is the authoritative boundary between the Vue 3 client and the ASP.NET Core Identity backend. Any DTO shape, endpoint, error, or header change must be reflected here first.
